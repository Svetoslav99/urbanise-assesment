    ...
    if (req.method === 'POST') {
        try {
            ...
            const retrievedManagerFormatted = {
                ...retrievedManager,
                managedSince: retrievedManager.managedSince.toLocaleDateString()
            };
            const retrievedPrevManagerFormatted = {
                ...retrievedPreviousManager,
                managedSince: retrievedPreviousManager.managedSince.toLocaleDateString()
            };
            ...
            const dataObj: DetailedProperty = {
                ...
                planRegistered: retrievedDetailedProperty.planRegistered.toLocaleDateString(),
